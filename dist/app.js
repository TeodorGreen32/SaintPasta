...
var menuBurger = header.querySelector('.menu-burger');
var menuList = header.querySelector('.menu__list');
var headerPhone = header.querySelector('.header__phone-wrapper');
...
var stickyHeader = function stickyHeader(entries, observer) {
  if (!entries[0].isIntersecting) header.classList.add('header--sticky');else header.classList.remove('header--sticky');
};

var headerObserver = new IntersectionObserver(stickyHeader, {
  root: null,
  threshold: 0
});
...
var slickify = function slickify() {
